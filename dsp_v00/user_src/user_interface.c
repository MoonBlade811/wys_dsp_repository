...
void DAM_Tran()
{
    ...
    A_DSPWRFPGA_DAMREG1=(unsigned int)(NetVoltage_meas*65535.0/1000);
    A_DSPWRFPGA_DAMREG2=(unsigned int)(FCVoltage_meas*65535.0/1000);
    A_DSPWRFPGA_DAMREG3=(unsigned int)((BuckOutVol_meas)*65535.0/1000);
    A_DSPWRFPGA_DAMREG4=(unsigned int)((DCDCOutVol_meas)*65535.0/1000);
    A_DSPWRFPGA_DAMREG5=(unsigned int)((Uun_meas+400)*65535.0/800);
    A_DSPWRFPGA_DAMREG6=(unsigned int)((Uvn_meas+400)*65535.0/800);
    A_DSPWRFPGA_DAMREG7=(unsigned int)((Uwn_meas+400)*65535.0/800);
    A_DSPWRFPGA_DAMREG8 =(unsigned int)((Icurr_pu_u_meas+250)*65535.0/500);
    A_DSPWRFPGA_DAMREG9=(unsigned int)((Icurr_pu_v_meas+250)*65535.0/500);
    A_DSPWRFPGA_DAMREG10=(unsigned int)((Icurr_pu_w_meas+250)*65535.0/500);
    A_DSPWRFPGA_DAMREG11 =(unsigned int)((UDPID.MeasurePoint)*65535.0/400);
    A_DSPWRFPGA_DAMREG12=(unsigned int)((UDPID.SetPoint)*65535.0/400);
    A_DSPWRFPGA_DAMREG13=(unsigned int)((UDPID.OutputPoint)*65535.0/400);
    A_DSPWRFPGA_DAMREG14=(unsigned int)((UQPID.MeasurePoint+50)*65535.0/100);
    A_DSPWRFPGA_DAMREG15 = (unsigned int)((UQPID.OutputPoint+50)*65535.0/100);
    A_DSPWRFPGA_DAMREG16=(unsigned int)(((BuckReg.OutputPoint))*65535.0/800);
    A_DSPWRFPGA_DAMREG17=(unsigned int)((buck_lessvol_flag)*65535.0/2);
    A_DSPWRFPGA_DAMREG18=(unsigned int)((buck_overvol_flag)*65535.0/2);
    A_DSPWRFPGA_DAMREG19 = (unsigned int)((SoftStop)*65535.0/2);
    A_DSPWRFPGA_DAMREG20=(unsigned int)((SoftStart)*65535.0/2);
    A_DSPWRFPGA_DAMREG21=(unsigned int)((SysStart)*65535.0/2);
    A_DSPWRFPGA_DAMREG22=(unsigned int)((SPLLReg.SpllAngle)*65535.0/10);
    A_DSPWRFPGA_DAMREG23 = (unsigned int)((SVPWMReg.RoAngle)*65535.0/10);
    A_DSPWRFPGA_DAMREG24=(unsigned int)((KM3ClsCmd)*65535.0/2);
    A_DSPWRFPGA_DAMREG25=(unsigned int)((SIV_V)*65535.0/400);
    A_DSPWRFPGA_DAMREG26=(unsigned int)((SIV_F*100)*65535.0/6000);
    A_DSPWRFPGA_DAMREG27 = (unsigned int)((PQData.SIV_P+20E3)*65535.0/40E3);
    A_DSPWRFPGA_DAMREG28=(unsigned int)((PQData.SIV_Q+20E3)*65535.0/40E3);
    A_DSPWRFPGA_DAMREG29=(unsigned int)((Icurr_u_meas+250)*65535.0/500);
    A_DSPWRFPGA_DAMREG30=(unsigned int)((0-(Uvn_meas+Uwn_meas)+400)*65535.0/800);
    A_DSPWRFPGA_DAMREG31=(unsigned int)((Icurr_bus_meas)*65535.0/100);
    A_DSPWRFPGA_DAMREG32 = (unsigned int)(DCDCReg.OutputPoint*65535.0/800);
